...
/* Routine Description: Given a Class GUID, this function will return the index of the
...
/*	Routine Description: Primary callback routine for the dialog box.
...
Return Value: returns True if this function processed the message.
*/
BOOL CALLBACK EnableDisableDialogProc(HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
...
/*	Routine Description: Standard entry point for a Win32 Application ( Non-Console )

	Arguments: Standard WinMain() Arguments

	Return Value: Allways returns 0 ( TRUE ).
*/
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	wc.lpszClassName 	= TEXT("EnableDisable");
    ...
    DialogBoxParam(hInstance, MAKEINTRESOURCE(IDD_DIALOG1),
        0, (DLGPROC)EnableDisableDialogProc, (LPARAM)hInstance);
