...
/*	Routine Description: Should we display the Device Nodes for the given Class?
...
/*	Routine Description: Wrapper arround the SetupDiGetDeviceRegistryProperty() API call.
...
*/
BOOL GetRegistryProperty(HDEVINFO  DeviceInfoSet, PSP_DEVINFO_DATA  DeviceInfoData,
...
/*	Routine Description: Given a DeviceNode, will try to construct a Human Readable Name
...
/*	Routine Description: Can this DevNode be disabled?
...
/*	Routine Description: Is this DevNode Disabled?
